namespace MessagingService.EmailMessage.DomainEvents
{
    ...
    public record EmailMessageRejectedEvent : DomainEventRecord.DomainEvent
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="EmailMessageRejectedEvent"/> class.
        /// </summary>
        /// <param name="aggregateId">The aggregate identifier.</param>
        /// <param name="providerStatus">The provider status.</param>
        /// <param name="rejectedDateTime">The rejected date time.</param>
        public EmailMessageRejectedEvent(Guid aggregateId,

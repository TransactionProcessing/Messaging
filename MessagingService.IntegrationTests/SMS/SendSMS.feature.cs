...
namespace MessagingService.IntegrationTests.SMS
{
    ...
    public partial class SendSMSFeature : object, Xunit.IClassFixture<SendSMSFeature.FixtureData>, Xunit.IAsyncLifetime
    {
...
#line hidden
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.InitializeAsync()
            {
                await SendSMSFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.DisposeAsync()
            {
                await SendSMSFeature.FeatureTearDownAsync();
            }
        }
    }
}
